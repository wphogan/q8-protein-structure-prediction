...
if __name__ == "__main__":
    ...
    if "dummy" in experiment:
        tr5534_data = json.load(open("../preprocess/CB513.json", "r"))
        cb513_data = json.load(open("../preprocess/CB513.json", "r"))
    else:
        tr5534_data = json.load(open("../preprocess/TR5534.json", "r"))
        cb513_data = json.load(open("../preprocess/CB513.json", "r"))
